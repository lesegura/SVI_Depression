...
adultos <- adultos |>
  select(upm:numren, edad:diferencia, usa_lentes = p14_1, 
         disc_visual = p14_3, p2_1_1:p2_1_7)
```
...
- p3_19_02 = 2 del ISSSTE?
- p3_19_03 = 3 del ISSSTE Estatal?
- p3_19_04 = 4 de Pemex?
- p3_19_05 = 5 de Defensa
- p3_19_06 = 6 de Marina?
- p3_19_07 = 7 del Seguro Popular o Seguro Médico Siglo XXI?
- p3_19_08 = 8 de IMSS PROSPERA (antes Oportunidades)?
- p3_19_09 = 9 de un seguro privado de gastos médicos?
- p3_19_10 = 10 de otra institución?
- p3_19_11 = 11 ¿No está afiliado o inscrito a servicios médicos?
- p3_19_99 = 99 No sabe

```{r}
residentes <- residentes |>
  select(upm:numren, nivel, l_indigena = p3_11, trabajo = p3_21, 
         p3_10_01:p3_10_11, p3_10_99)
```
