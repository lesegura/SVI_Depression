...
plot_poster <- betas_plot |>
  mutate(level =  factor(level),  
         ...
         color = factor(c(1, rep(2, 3), rep(3, 2), rep(4, 3), rep(5, 2), 
                   ...
                   labels = c("Overall", "Age group", "Sex", "SES", "Indigenous", 
...
figure_1 <- plot_poster + plot_annotation(title = "Figure 1. Prevalence ratios of depressive symptomatology among those with and without severe visual impairment by sociodemographic groups.", 
...
ggsave(here("results/", "forestplot_poster.pdf"), plot = figure_1, device = cairo_pdf, 
       width = 26, height = 14, units = "in", dpi = 1800)
