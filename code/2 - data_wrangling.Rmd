...
ensanut18_4analysis <- ensanut18_all |>
  ...
  mutate(ses = factor(case_when(estrato == 1 ~ 4, 
         ...
         insurance = factor(case_when(p3_10_01 == 1 | p3_10_02 == 1 | p3_10_03 == 1 |
                                     p3_10_04 == 1 | p3_10_05 == 1 | p3_10_06 == 1 |
                                     p3_10_07 == 1 | p3_10_08 == 1 | p3_10_09 == 1 |
                                     p3_10_10 == 1 ~ 1, 
                                     p3_10_11 == 1 ~ 0, 
                                     p3_10_99 == 1 ~ NA), 
                            labels = c("No insurance", "Insurance")), 
...
ensanut18_4analysis <- ensanut18_4analysis |>
  select(upm:ent, region, est_dis:f_20mas, age_cat, sexo, urbanicity, education, ses,
         ...
         disc_visual_severa_num, cesd_score, cesd)
